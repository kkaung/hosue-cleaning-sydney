...
import HeroTwoImage from '/public/assets/images/hero-two.jpg';
                ...
                <Card className="max-w-lg shadow-none border-none md:shadow-lg md:rounded-xl">
                    <CardHeader className="py-6 pt-0 px-0 md:p-6 md:pb-0 md:pt-6">
                        <h1 className="font-extrabold text-4xl leading-none">
                            <Balancer>
                                Sydney's Most In Demand House Cleaning Company
                            </Balancer>
                        </h1>
                    </CardHeader>
                    <CardContent className="space-y-8 p-0 md:p-6">
                        <p className="text-muted-foreground text-base">
                            Say hello to sparkling surfaces and free time,
                            Sydney's most in-demand cleaning company. We offer
                            eco-friendly services, tailored solutions, and
                            reliable cleaners who treat your home with care.
                        </p>
                        <div className="space-y-3 leading-tight">
                            ...
                            <div className="flex items-center">
                                <Icons.check
                                    ...
                                    strokeWidth={3}
                                />
                                <p>100% Statisfaction Guarantee</p>
                            </div>
                            <div className="flex items-center">
                                <Icons.check
                                    className="w-4 h-4 mr-2"
                                    ...
                                    strokeWidth={3}
                                />
                                <p>Trusted by 2000+ homes in Sydney</p>
                            </div>
                        </div>
